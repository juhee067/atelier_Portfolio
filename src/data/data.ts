...
export const projectData = [
  ...
  },
  {
    ...
    des: "메신저 대화 분석 시각화 웹은 사용자들에게 카카오톡 대화 데이터를 더 잘 이해하고, 관리할 수 있는 도구를 제공하며, 그래프 및 차트를 통해 데이터의 시각화를 지원합니다.사용자는 개인적인 데이터를 분석하고 공유하며, 대화 기록을 효과적으로 관리할 수 있게 됩니다.",
    background:
  ...
  },
  {
    ...
    des: "메시지 전달형 자살예방웹사이트는 중요한 사회 문제를 다루는 동시에 사용자 경험을 개선하고 안전하게 소통할 수 있는 기능을 강조합니다. 사용자들에게 우울증 및 자살 예방에 대한 정보와 지원을 제공하며, 커뮤니티와 응원 메시지 게시판을 통해 서로에게 지원과 희망을 주는 플랫폼을 제공합니다.",
    background:
  ...
  },
  {
    ...
    src: `s`,
    des: "와인 공유 커뮤니티는 중요한 사회 문제를 다루는 동시에 사용자 경험을 개선하고, 안전하게 소통할 수 있는 기능을 강조합니다. 사용자들에게 우울증 및 자살 예방에 대한 정보와 지원을 제공하며,커뮤니티와 응원 메시지 게시판을 통해 서로에게 지원과 희망을 주는 플랫폼을 제공합니다.",
    background:
      "평소, 정신적으로 고통 받고 있는 친구들이 주변에 많았습니다. 이 친구들에게 가장 좋은 치료약은 무엇일까? 생각해보다가 그들에게 가장 필요한 것은 도움이라 생각이 들어 그 친구들에게 맞는 위로의 메세지 전달해주자는 마음에 기획하게되었습니다. 졸업전시회에서 사용한 프로젝트를 리뉴얼하여 그들에게 필요한 지원을 다시 전하고자 합니다. ",
    isModal: false,
